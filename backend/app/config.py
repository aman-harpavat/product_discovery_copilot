...
class Settings(BaseModel):
    ...
    fast_mode_reddit_result_limit: int = 60
    ...
    full_mode_reddit_result_limit: int = 120
    full_mode_reddit_max_total_seconds: float = 45.0
    ...
    fast_mode_app_store_max_pages: int = 2
    full_mode_app_store_max_pages: int = 4
